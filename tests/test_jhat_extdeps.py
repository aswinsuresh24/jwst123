...
def test_custom_jhat_import_and_location():
    ...
    assert version.endswith('+jwst123'), version
    # Core API used by jwst123.alignment.align / relative_align.
