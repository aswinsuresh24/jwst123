...
from jwst123.alignment import alignment_wrap as wrap
...
from jwst123.scripts import alignment_wrap as wrap_script
...
def test_combine_dispersion_and_rank_parents():
    ...
    with patch(
        'jwst123.alignment.alignment_fallback.sky_overlap_fraction',
