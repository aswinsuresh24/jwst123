"""Tests for align script helpers used by jwst123.scripts.align."""
...
def test_align_main_empty_workdir(tmp_path: Path):
    ...
    with (
        patch('jwst123.scripts.align.get_input_images', return_value=[]),
        patch('jwst123.scripts.align.input_list', return_value=empty),
        patch('jwst123.scripts.align.visit_filter_dict', return_value={}),
    ):
