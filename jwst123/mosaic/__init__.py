...
Submodules
----------
- :mod:`jwst123.mosaic.region` — illuminated footprints and ``S_REGION`` polygons
- :mod:`jwst123.mosaic.image_overlap` — science vs reference footprint overlap
- :mod:`jwst123.mosaic.mosaic` — overlap splitting, PSF matching, coadds, GWCS,
  DOLPHOT prep

Heavy symbols from :mod:`jwst123.mosaic.mosaic` are resolved lazily so importing
...
def __getattr__(name: str) -> Any:
    if name in _MOSAIC_LAZY:
        from jwst123.mosaic import mosaic as mosaic_mod
