...
overlapping references), then runs ``jwst123.alignment.align_jwst_image`` (which
...
Library module: ``jwst123.alignment.relative_align``.
"""
...
def iterative_sigma_clip_matches(
    ...
    *,
    ...
    matched = jwst123.xmatch_common(jh, rf, dist_limit=dist_limit_arcsec)
    if len(matched) == 0:
